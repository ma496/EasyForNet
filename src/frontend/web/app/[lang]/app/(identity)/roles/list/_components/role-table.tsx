    ...
    columnHelper.display({
      ...
      cell: (info) => (
        <div className="flex items-center gap-2">
          {canUpdate && (
            <LocalizedLink href={`/app/roles/update/${info.row.original.id}`} className="btn btn-secondary btn-sm">
          ...
          {canChangePermissions && (
            <LocalizedLink href={`/app/roles/change-permissions/${info.row.original.id}`} className="btn btn-primary btn-sm">
