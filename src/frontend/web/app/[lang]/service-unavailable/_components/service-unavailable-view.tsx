      ...
      <div className="relative z-10 px-6 py-16 text-center font-nunito">
        <div className="relative flex flex-col items-center">
          ...
          <div className="relative mb-12 group">
            <div className="absolute inset-0 bg-warning/20 blur-3xl rounded-full scale-150 animate-pulse" />
            ...
            <div className="relative bg-white dark:bg-black/20 p-10 md:p-14 rounded-[3rem] border border-white/20 shadow-2xl backdrop-blur-xl transition-transform duration-500 group-hover:scale-105">
              <ServerOff className="w-24 h-24 md:w-32 md:h-32 text-warning" strokeWidth={1.2} />
            </div>
            <div className="absolute -top-6 -right-6 bg-warning text-white font-black text-2xl md:text-3xl px-6 py-3 rounded-2xl shadow-2xl rotate-12 border-4 border-white dark:border-[#060818] transform transition-transform duration-500 hover:rotate-0 hover:scale-110 cursor-default select-none">
              503
            </div>
          </div>
