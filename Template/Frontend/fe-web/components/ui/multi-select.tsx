...
export const MultiSelect = ({
  ...
  return (
    <div
      className={cn(className, error && showError && "has-error")}
      ref={containerRef}
    >
      ...
      >
        ...
        >
          ...
          <span className={cn("flex-1 flex flex-wrap gap-1 items-center min-h-[28px]", !value?.length && "text-gray-400")}
          >
      ...
      {showValidation && showError && error && (
